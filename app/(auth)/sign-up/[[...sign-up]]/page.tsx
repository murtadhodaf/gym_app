          ...
          {verifying ? (
            <>
              <h2 style={{ fontSize: 28, fontWeight: 500, letterSpacing: "-0.025em", margin: "0 0 6px", color: "var(--ink)" }}>
                Check your <em style={{ fontFamily: "var(--font-instrument)", fontStyle: "italic" }}>email.</em>
              </h2>
              <p style={{ color: "var(--ink-3)", marginBottom: 30, fontSize: 14 }}>
                We sent a code to <strong style={{ color: "var(--ink)" }}>{email}</strong>
              </p>
            ...
            <>
              <h2 style={{ fontSize: 28, fontWeight: 500, letterSpacing: "-0.025em", margin: "0 0 6px", color: "var(--ink)" }}>
                Start your <em style={{ fontFamily: "var(--font-instrument)", fontStyle: "italic" }}>journey.</em>
              </h2>
              <p style={{ color: "var(--ink-3)", marginBottom: 30, fontSize: 14 }}>
